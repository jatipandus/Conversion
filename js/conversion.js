...
function Mass(){
    ...
    if(document.getElementById("mass1").value === '4' && document.getElementById("mass2").value === '1'){
        var massTonne = document.getElementById("inputMass1").value;
        var massKilogram = (parseInt(massTonne) * (1000));
        document.getElementById("inputMass2").value = massKilogram;
    }
    
    if(document.getElementById("mass1").value === '2' && document.getElementById("mass2").value === '4'){
        var massGram = document.getElementById("inputMass1").value;
        var massTonne = (parseInt(massGram) / (1000000));
        document.getElementById("inputMass2").value = massTonne;
    }
    if(document.getElementById("mass1").value === '4' && document.getElementById("mass2").value === '2'){
        var massTonne = document.getElementById("inputMass1").value;
        var massGram = (parseInt(massTonne) * (1000000));
        document.getElementById("inputMass2").value = massGram;
    }

    if(document.getElementById("mass1").value === '3' && document.getElementById("mass2").value === '4'){
        var massPound = document.getElementById("inputMass1").value;
